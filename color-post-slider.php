...
class colorPostSliderWidget extends WP_Widget {
    ...
    function add_meta_boxes() {
        add_meta_box('bar-color', 'Post Color', array(&$this, 'box'), 'color_post', 'side');
    }

    function box($post) {
        wp_nonce_field('a_save', 'b_color');
        ?>
        <label for="color_post_color" style="display:block;">Post background color</label><input type="text" class="colorpick" name="color_post_color" value="<?php echo get_post_meta($post->ID, 'color_post_color', true); ?>" />
        <br />
        <label for="color_post_font"  style="display:block;">Post font color</label><input type="text" class="colorpick" name="color_post_font" value="<?php echo get_post_meta($post->ID, 'color_post_font', true); ?>" />
        <?php
    }
    ...
    function update_post($post_id) {
        if (isset($_POST['color_post_color']) || isset($_POST['color_post_font'])) {
            ...
            if (isset($_POST['color_post_font'])) {
                $colorBg = $_POST['color_post_font'];
                update_post_meta($post_id, 'color_post_font', $colorBg);
            }
        }
    }
...
function create_color_post_type() {
    register_post_type('color_post', array(
        'labels' => array(
